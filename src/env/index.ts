const {
  ...
  REACT_APP_SECOND_RPC_URL,
  REACT_APP_SECOND_CHAIN_ID,
  REACT_APP_SECOND_CHAIN_NAME,
} = process.env;
...
export const SECOND_RPC_URL = REACT_APP_SECOND_RPC_URL as string;
export const SECOND_CHAIN_ID = Number(REACT_APP_SECOND_CHAIN_ID);
export const SECOND_CHAIN_NAME = REACT_APP_SECOND_CHAIN_NAME as string;
